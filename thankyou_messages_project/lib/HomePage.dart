import 'dart:async';
import 'dart:io';
import 'package:thankyou_messages/data/Messages.dart';
...
import 'package:thankyou_messages/StatusList.dart';
import 'package:thankyou_messages/widgets/CustomFBTextWidget.dart';
import 'package:thankyou_messages/widgets/CustomFeatureCard.dart';
import 'package:thankyou_messages/widgets/CustomFullCard.dart';
                ...
                children: [
                  DesignerContainer(
                    ...
                    child: Padding(
                      ...
                      child: Center(
                        child: Text("Select Your Type From Below",
                  ...
                  DesignerContainer(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: Text("Select Your Languages For Messages ",
                              style: Theme.of(context).textTheme.headline1),
                        ),
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                  ...
                  DesignerContainer(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: Text("Generate Thank You E-Cards",
                              style: Theme.of(context).textTheme.headline1),
                        ),
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                  ...
                  DesignerContainer(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: Text("Thank You Status Wishes",
                              style: Theme.of(context).textTheme.headline1),
                        ),
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
